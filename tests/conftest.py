"""
conftest.py — Minimale Pytest-Fixtures für Story Navigation E2E Tests
Nur Playwright-Fixtures (kein Backend/WebSocket/asyncio).
"""
import pytest
...
def page(html_file):
    ...
    Beispiel mit Override:
      PLAYWRIGHT_VIEWPORT_WIDTH=800 pytest tests/test_story_nav_e2e.py
    """
    import os
