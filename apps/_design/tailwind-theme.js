/**
 * Kirobi Tailwind Theme Extension — Source of Truth.
 * Zone: WORKSPACE
 *
 * NOTE: Next.js apps cannot share tailwind config across build contexts without
 * an npm workspace. Repo policy (AGENTS.md) is no workspace. So copy the
 * `theme.extend` block below into each app's tailwind config when changed:
 *
 *   - apps/web/tailwind.config.js
 *   - apps/dashboard/tailwind.config.ts
 *   - apps/voice/tailwind.config.ts
 *
...
module.exports = {
  colors: {
    // Unified kirobi scale (cyan-teal). Replaces three different per-app palettes.
    kirobi: {
      50:  '#ecfeff',
      100: '#cffafe',
      200: '#a5f3fc',
