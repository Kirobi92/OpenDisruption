...
**Rolle:** Code-Generierung, Refactoring, Tests, CI/CD
**Phase:** 0 (Skelett)

Dieser Vault gehört dem Agenten `opencode`. Er nutzt ihn für eigene Arbeitsnotizen, Zwischenergebnisse und Reflexion. Kollaborative Inhalte landen im Shared-Vault unter `obsidian/shared-opendisruption/`.
