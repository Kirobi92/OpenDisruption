...
**Zone:** WORKSPACE
**Owner-Agent:** `kidi`
**Rolle:** Konfidenz-gewichtete Synthese über ContextDB-Einträge
**Phase:** 0 (Skelett)

Dieser Vault gehört dem Agenten `kidi`. Er nutzt ihn für eigene Arbeitsnotizen, Zwischenergebnisse und Reflexion. Kollaborative Inhalte landen im Shared-Vault unter `obsidian/shared-opendisruption/`.
